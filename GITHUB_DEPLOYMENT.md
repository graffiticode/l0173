...
5. Select your repository: `graffiticode/l0173`
6. Click "Connect"
...
2. Configure:
   - **Name**: `l0173-production-deploy`
   - **Description**: Deploy L0173 to production on main branch push
...
1. Click "Create Trigger"
2. Configure:
   - **Name**: `l0173-staging-deploy`
   - **Description**: Deploy L0173 staging on branch push
   - **Event**: Push to a branch
   - **Source**:
     - Repository: Your connected repo
...
```bash
PROJECT_ID=$(gcloud config get-value project)
GITHUB_REPO="graffiticode/l0173"
...
- URL: https://l0173-[hash]-uc.a.run.app
...
- URL: https://l0173-staging-[hash]-uc.a.run.app
- Full traffic routing
- Maximum instances: 10
- Memory: 256Mi

### Preview (feature branches)
- URL: https://l0173-[branch-name]-[hash]-uc.a.run.app
...
gcloud run services update-traffic l0173 \
  --to-revisions=l0173-00005-abc=100 \
  --region=us-central1
```
...
3. Verify port configuration (50173)
