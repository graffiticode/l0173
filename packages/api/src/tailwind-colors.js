...
// Tailwind v3 default color palette (token → hex). Used by the compiler
// to resolve color tokens like "blue-500" to "#3b82f6" before they're
// passed to ECharts. Tokens that don't appear here fall through; the
// caller may already be passing a hex string or a CSS color.
...
const TAILWIND = {
  ...
  "rose-50":     "#fff1f2", "rose-100":    "#ffe4e4", "rose-200":    "#fecdd3",
...
// Reverse helper for tests / debugging.
export const palette = TAILWIND;
